    ...
    return (
        <>
            ...
            {type === "internet" &&
                <>
                    <h2 className="text-2xl font-bold">
                        <span className="text-[#ef9831]">{city}, {state}</span>  Internet FAQ’s
            ...
            {type === "tv" &&
                <>
                    <h2 className="text-2xl font-bold">
                          <span className="text-[#ef9831]">{city}, {state}</span> TV FAQ’s               </h2>
            ...
            {type === "internet-tv" &&
                <>
                    <h2 className="text-2xl font-bold">
                          <span className="text-[#ef9831]">{city}, {state}</span> Internet and TV FAQ’s;              </h2>
