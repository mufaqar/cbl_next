...
function InternetTVPlanBox({ Plans, pro_phone }: any) {
    return (
        <>
            ...
            <div className="w-full md:w-full lg:max-w-[1200px] mx-auto h-auto  overflow-x-scroll">
                <div className="w-full h-auto shadow-xl border rounded-t-md rounded-b-md flex md:flex-col flex-row items-stretch">
                    ...
                    {Plans?.map((plan: any) => (
                        <div key={plan.id} className='md:w-full grid md:grid-cols-5 grid-cols-1 dtable w-[320px]' >
                            <div className=" w-[150px] md:border-r border-r-0 md:border-b-0 border-b grid justify-center md:p-5 p-2 md:h-auto h-[120px] overflow-hidden items-center">
                                <div>
