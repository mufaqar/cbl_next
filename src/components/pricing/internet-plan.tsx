...
const InternetPlans = ({ internetPlans, pro_phone }: any) => {

    return (
        <div className=" w-full lg:max-w-[1200px] mx-auto  h-auto  border-zinc-400/10 ">
            <div className="  w-full h-auto shadow-md border rounded-t-md  ">
