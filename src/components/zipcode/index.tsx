    ...
    return (
        <>
          <PageHead
            ...
            url={`https://www.cablemovers.net/${state_code}/${city_code}?zipcode=${zipcode}&type=${type}`} curl={`https://www.cablemovers.net/${state}/${city_code}`}
           />
                ...
                <section className="my-16">
                    <div className="container mx-auto px-4">
                        <div className='mb-10'>
                            ...
                            <p className='text-xl font-[Roboto] mt-5'>If speed is your top priority consider the following {formatType(type)}  Service Providers in {city}, {C_State}.</p>
                        </div>
